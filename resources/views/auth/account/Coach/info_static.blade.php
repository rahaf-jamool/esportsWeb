	...
	<div class="your-order">
		<div class="row text-center">
			...
			<h4 class="p-4">{!! trans('auth.personal-information') !!}</h4>
                ...
                @endif
                @if (!empty($user['personInfo']['idCardNumber']))
                <div class="col-12 col-lg-6 m-2 border-bottom mx-auto p-2 d-flex justify-content-between">
					<div class="col-6 text-center">
						<strong class="product-quantity">
                ...
                @endif
                @if (!empty($user['personInfo']['membershipNumber']))
                    <div class="col-12 col-lg-6 m-2 border-bottom mx-auto p-2 d-flex justify-content-between">
                        <div class="col-6 text-center">
                            <strong class="product-quantity">
                        ...
                        <div class="col-6">
                            <p>{{ $user['personInfo']['membershipNumber'] }}</p>
                        </div>
                    </div>
                @endif
                ...
                @endif
				@if (!empty($user['personInfo']['passport']['imagePath']))
                <div class="col-12 col-lg-6 m-2 border-bottom mx-auto p-2 d-flex justify-content-between">
                    <div class="col-6 text-center">
                        {{trans('individually.passport-photo')}}
                    </div>
                    <div class="col-6">
                        @if($user['personInfo']['passport']['imagePath'] != '' )
                            <img class="responsive" src="{{ config('app.base_address') . $user['personInfo']['passport']['imagePath']}}" width="150" alt="logo"
                            onerror="this.onerror=null;this.src='{{asset('SD08/default-user-image.png')}}';" style="border-radius: 50%;height: 100%;">
                        @else
                            <img class="responsive" src="{{  url(asset('SD08/default-user-image.png')) }}" width="150" alt="logo"/>
                        @endif
                    </div>
                </div>
                @endif
