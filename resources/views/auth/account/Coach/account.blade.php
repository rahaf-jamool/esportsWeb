		...
		{{-- <div class="container p-0" id="account-content"> --}}
			<div class="tab-content">
				...
				<div id="info" class="tab-pane active">
					@include('auth.account.Coach.info_static', compact('user'))
				</div>
				{{-- <div id="playersManagement" class="tab-pane">
					@include('auth.account.Coach.playersManagement', compact('user'))
				</div> --}}
				...
				<div id="membershipCard" class="tab-pane">
                    @include('auth.account.Coach.membership-card', compact('user'))
				</div>
