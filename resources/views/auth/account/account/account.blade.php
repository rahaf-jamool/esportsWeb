		...
		{{-- <div class="container p-0" id="account-content"> --}}
			<div class="tab-content">
				...
				<div id="electronicservices" class="tab-pane">
					@include('auth.account.player.electronicservices', compact('user'))
				</div>
				{{-- <div id="articles" class="tab-pane">
					@include('auth.account.player.articles', compact('user'))
				</div> --}}
				<div id="SubscribeToEvents" class="tab-pane">
					@include('auth.account.player.SubscribeToEvents', compact('user'))
				</div>
			</div>
		{{-- </div> --}}
	</div>
