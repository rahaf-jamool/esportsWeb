...
@endphp
<div class="container club-register-new-player w-100">
    <div class="row pt-3">
        <h1> {!! trans('institutions.privateacademyRegistration') !!}</h1>

        <div class="col-12">
            <form id="academy_register_form" enctype="multipart/form-data">
                {{ csrf_field() }}
                <hr class="m-2 mb-4">
                <input type="hidden" name="team-id" value="{{ $team['result']['id'] }}">
                <input type="hidden" name="teamHeadId" value="{{ $team['result']['teamHeadId'] }}">
                <input type="hidden" name="account-type" value="Academy">
                <div class="form-group{{ $errors->has('uaeResidency') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-12 col-lg-9 radio-btn">
                        <label class="radio-inline">
                            <input class="mx-2" type="radio" name="uaeResidency" value="1" style="" checked="checked">{{trans('individually.inside-state')}}
                        </label>
                        <label class="radio-inline">
                            <input class="mx-2" type="radio" name="uaeResidency" value="0">{{trans('individually.out-country')}}
                        </label>
                ...
                <div class="form-group{{ $errors->has('isEventCreator') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-12 col-lg-9 radio-btn">
                        <label class="radio-inline">
                            <input class="mx-2" type="radio" name="isEventCreator" value="true" style="" checked="checked">{{trans('individually.yes')}}
                        </label>
                        <label class="radio-inline">
                            <input class="mx-2" type="radio" name="isEventCreator" value="false">{{trans('individually.no')}}
                        </label>
                ...
                <div class="form-group residence-only {{ $errors->has('emirates-personal-passport-photo') ? ' has-error' : '' }}">
                    <label for="emirates-personal-passport-photo" class="col-11 control-label pb-2 pt-2">{{trans('individually.Academy-logo')}}</label>
                ...
                <div class="form-group{{ $errors->has('licenceEndDate') ? ' has-error' : '' }}">
                    ...
                    <div class="col-12">
                        <input id="licenceEndDate" type="date" class="form-control" name="licenceEndDate">
                ...
                <div class="alert alert-success text-center success-register-academy-message d-none"></div>
                <div class="alert alert-danger text-center error-register-academy-message d-none"></div>
