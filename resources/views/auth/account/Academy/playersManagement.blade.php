...
<!-- 								<td><a type="button" href="javascript:void(0)"><i class="fa fa-eye" aria-hidden="true"></i></a></td>
 -->							
                            <td >
									<span class="m-1 btn btn-success player-details-ajax" data-userId="{{$player['id']}}" data-toggle="modal" data-target="#clubPlayerDetailsModel" style="cursor: pointer;">{{ trans('site.show') }}</span>
									...
									<a href="{{url(App::getLocale() . '/profile/editPlayerClub/'. $player['id'])}}">
                                        <span class="m-1 btn btn-primary player-edit" style="cursor: pointer;">{{ trans('site.edit') }}</span>
                                    </a>
