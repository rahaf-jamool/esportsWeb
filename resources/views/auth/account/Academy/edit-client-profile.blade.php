	...
	<div class="information" style="margin-top: 50px">
		<div class="container" style="padding-top: 100px;">
            ...
            <form class="form-horizontal" role="form" method="POST" action="{{ url(App::getLocale() . '/profile/edit/' . $user['id']) }}" enctype="multipart/form-data">
                ...
                <h4>{!! trans('institutions.privateacademyDetails') !!}</h4>
                <hr>
                <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                    <span class="asterisks">*</span><label for="name" class="col-11 control-label  pb-2 pt-2">{{trans('institutions.privateacademyName')}}</label>
                    <div class="col-12">
                        <input id="name" type="text" class="form-control" name="name" class="form-control {{$errors->first('name') ? "is-invalid" : "" }} "
                ...
                {{-- <div class="form-group{{ $errors->has('userName') ? ' has-error' : '' }}">
                    ...
                    <div class="col-12">
                        <input id="userName" type="text" class="form-control {{$errors->first('userName') ? "is-invalid" : "" }} "
                                value="{{ is_null($user['client']['userName']) ? '' : $user['client']['userName']}}" name="userName" required>
                ...
                <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                    ...
                    <div class="col-12">
                        <input id="email" type="email" class="form-control" name="email" class="form-control {{$errors->first('email') ? "is-invalid" : "" }} "
                                value="{{ is_null($user['orgnizationInfo']['email']) ? '' : $user['orgnizationInfo']['email']}}" required>
                        @if ($errors->has('email'))
                            <span class="help-block">
                ...
                <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                    ...
                    <div class="col-12">
                        <input id="phone" type="text" class="form-control" class="form-control {{$errors->first('phone') ? "is-invalid" : "" }} "
                                value="{{ is_null($user['orgnizationInfo']['phone']) ? '' : $user['orgnizationInfo']['phone']}}" name="phone">
                        @if ($errors->has('phone'))
                            <span class="help-block">
                ...
                <div class="form-group{{ $errors->has('licenceEndDate') ? ' has-error' : '' }}">
                    ...
                    <div class="col-12">
                        <input id="licenceEndDate" type="date" class="form-control" class="form-control {{$errors->first('licenceEndDate') ? "is-invalid" : "" }} "
                    ...
                    <div class="col-sm-12 input-group mb-3">
                        <div class="picture-container">
                            <div class="picture">
                                ...
                                <input type="file" id="wizard-picture" name="licenceImage" value="{{ is_null($user['orgnizationInfo']['licenceImagePath']) ? '' : $user['orgnizationInfo']['licenceImagePath']}}"
                                class="form-control {{$errors->first('licenceImage') ? "is-invalid" : "" }} ">
                ...
                <div class="form-group{{ $errors->has('OName') ? ' has-error' : '' }}">
                    <span class="asterisks">*</span><label for="OName" class="col-11 control-label  pb-2 pt-2">{{trans('all.name')}}</label>
                    <div class="col-12">
                        <input id="OName" type="text" name="OName" class="form-control {{$errors->first('OName') ? "is-invalid" : "" }} "
                                value="{{ is_null($user['orgnizationInfo']['owner']['name']) ? '' : $user['orgnizationInfo']['owner']['name'] }}" required autofocus>
                        @if ($errors->has('OName'))
                            <span class="help-block">
                ...
                <div class="form-group{{ $errors->has('princedomId') ? ' has-error' : '' }}">
                    <label for="princedomId" class="col-11 control-label pb-2 pt-2">{{trans('institutions.princedoms')}}</label>
                    <div class="col-12">
                        <select name="princedomId" class="form-select" id="princedomId" style="direction: ltr;">
                ...
                <div class="form-group{{ $errors->has('StartDate') ? ' has-error' : '' }}">
                    ...
                    <div class="col-12">
                        <input id="StartDate" type="date" class="form-control" value="{{ is_null(Carbon\Carbon::parse($user['orgnizationInfo']['owner']['passport']['startDate'])->format('Y-m-d')) ? '' : Carbon\Carbon::parse($user['orgnizationInfo']['owner']['passport']['startDate'])->format('Y-m-d') }}" name="StartDate">
                ...
                <div class="form-group{{ $errors->has('passport-file ') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-12 input-group mb-3">
                        <div class="picture-container">
                            <div class="picture">
                                <img src="{{ config('app.base_address') . $user['orgnizationInfo']['owner']['passport']['imagePath'] }}" class="picture-src" id="wizardPicturePreview1" height="200px" width="100%" title="" style="margin: 20px 0;"/>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group required  {{ $errors->has('twitter') ? ' has-error' : '' }}">
                                ...
                                value="{{ is_null($user['orgnizationInfo']['twitter']) ? '' : $user['orgnizationInfo']['twitter'] }}">
                                </div>
                        ...
                        <div class="col-6">
                            <div class="form-group required {{ $errors->has('instagram') ? ' has-error' : '' }}">
                                ...
                                value="{{ is_null($user['orgnizationInfo']['instagram']) ? '' : $user['orgnizationInfo']['instagram'] }}">
                                </div>
                        ...
                        <div class="col-6">
                            <div class="form-group required {{ $errors->has('facebook') ? ' has-error' : '' }}">
                                ...
                                value="{{ is_null($user['orgnizationInfo']['facebook']) ? '' : $user['orgnizationInfo']['facebook'] }}">
                                </div>
                        ...
                        <div class="col-6">
                            <div class="form-group required {{ $errors->has('youtube') ? ' has-error' : '' }}">
                                ...
                                value="{{ is_null($user['orgnizationInfo']['youTube']) ? '' : $user['orgnizationInfo']['youTube'] }}">
                                </div>
                        ...
                        <div class="col-6">
                            <div class="form-group required {{ $errors->has('discord') ? ' has-error' : '' }}">
                                ...
                                value="{{ is_null($user['orgnizationInfo']['discord']) ? '' : $user['orgnizationInfo']['discord'] }}">
                                </div>
                        ...
                        <div class="col-6">
                            <div class="form-group required {{ $errors->has('tikTok') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" name="tikTok" value="" id="tikTok"  class="form-control input-player{{$errors->first('tikTok') ? "is-invalid" : "" }} "
                                value="{{ is_null($user['orgnizationInfo']['tikTok']) ? '' : $user['orgnizationInfo']['tikTok'] }}">
                                </div>
                        ...
                        <div class="col-6">
                            <div class="form-group required {{ $errors->has('twitch') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" name="twitch" value="" id="twitch"  class="form-control input-player{{$errors->first('twitch') ? "is-invalid" : "" }} "
                                value="{{ is_null($user['orgnizationInfo']['twitch']) ? '' : $user['orgnizationInfo']['twitch'] }}">
                                </div>
                        ...
                        <div class="col-6">
                            <div class="form-group{{ $errors->has('website') ? ' has-error' : '' }}">
                                ...
                                <div class="col-12">
                                    <input id="website" type="text" class="form-control" name="website" class="form-control input-player{{$errors->first('website') ? "is-invalid" : "" }} "
                                value="{{ is_null($user['orgnizationInfo']['website']) ? '' : $user['orgnizationInfo']['website'] }}">
                        ...
                        <div class="col-6">
                            <div class="form-group{{ $errors->has('address') ? ' has-error' : '' }}">
                                ...
                                <div class="col-12">
                                    <input id="address" type="text" class="form-control" name="address" class="form-control input-player{{$errors->first('address') ? "is-invalid" : "" }} "
                                value="{{ is_null($user['orgnizationInfo']['address']) ? '' : $user['orgnizationInfo']['address'] }}">
                        ...
                        <div class="col-6">
                            <div class="form-group{{ $errors->has('fax') ? ' has-error' : '' }}">
                                ...
                                <div class="col-12">
                                    <input id="fax" type="text" class="form-control" name="fax" class="form-control input-player{{$errors->first('fax') ? "is-invalid" : "" }} "
                                value="{{ is_null($user['orgnizationInfo']['fax']) ? '' : $user['orgnizationInfo']['fax'] }}">
                                    @if ($errors->has('fax'))
                                        <span class="help-block">
