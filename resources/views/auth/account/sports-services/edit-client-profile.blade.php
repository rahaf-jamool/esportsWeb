			...
			<form class="form-horizontal" role="form" method="POST" action="{{ url(App::getLocale() . '/profile/edit/' . $user['id']) }}" enctype="multipart/form-data">
                ...
                <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                        ...
                        {{-- <div class="form-group{{ $errors->has('licenceIssuar') ? ' has-error' : '' }} d-none">
                         ...
                         <div class="form-group{{ $errors->has('licenceEndDate') ? ' has-error' : '' }}">
                            ...
                            <div class="col-12">
                                ...
                                value="{{ is_null(Carbon\Carbon::parse($user['orgnizationInfo']['licenceEndDate'])->format('Y-m-d')) ? '' : Carbon\Carbon::parse($user['orgnizationInfo']['licenceEndDate'])->format('Y-m-d') }}" name="licenceEndDate" placeholder="{{ $user['orgnizationInfo']['licenceEndDate'] }}">
                        ...
                        {{-- <div class="form-group{{ $errors->has('lastName') ? ' has-error' : '' }}">
                            ...
                            <div class="col-12">
                                <input id="lastName" type="text" class="form-control {{$errors->first('lastName') ? "is-invalid" : "" }} "
                                value="{{ old('name') ? old('name') : $user['orgnizationInfo']['owner']['lastName'] }}" name="lastName" value="{{ old('lastName') }}" required autofocus>
                        ...
                        <div class="form-group residence-only {{ $errors->has('passportNumber') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-12">
                                <input type="number" name="passportNumber" value="{{ is_null($user['orgnizationInfo']['owner']['passport']['number']) ? '' : $user['orgnizationInfo']['owner']['passport']['number'] }}" min="0" id="passportNumber" class="form-control input-player" required>
                            </div>
                        ...
                        <div class="form-group{{ $errors->has('EndDate') ? ' has-error' : '' }}">
                            ...
                            <div class="col-12">
                                <input id="EndDate" type="date" class="form-control" name="EndDate" value="{{ is_null(Carbon\Carbon::parse($user['orgnizationInfo']['owner']['passport']['endDate'])->format('Y-m-d')) ? '' : Carbon\Carbon::parse($user['orgnizationInfo']['owner']['passport']['endDate'])->format('Y-m-d') }}">
