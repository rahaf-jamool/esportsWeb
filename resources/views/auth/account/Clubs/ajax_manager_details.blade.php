		...
		<div class="row text-center">
			<div class="col-12 col-md-8 col-lg-6 col-xl-4 mx-auto mb-3">
				...
				<div class="col-12 col-lg-6 m-2 border-bottom mx-auto p-2 d-flex justify-content-between">
					...
					<div class="col-6">
						<p>
						{{ !is_null($data['personInfo']['gender']) ? ($data['personInfo']['gender'] == 'M' ? 'Male' : 'Female') : '-------'}}
						</p>
					</div>
				</div>
				@endif
				...
				<div class="col-12 col-lg-6 m-2 border-bottom mx-auto p-2 d-flex justify-content-between">
					...
					<div class="col-6">
						<p>
						{{ !is_null($data['personInfo']['socialStatus']) ? ($data['personInfo']['socialStatus'] == 'married' ? 'Married' : 'Single') : '-------'}}
						</p>
					</div>
				</div>
				@endif
				...
				<div class="col-12 col-lg-6 m-2 border-bottom mx-auto p-2 d-flex justify-content-between">
					...
					<div class="col-6">
						<p>
						{{ !is_null($data['personInfo']['passport']['endDate'])?$data['personInfo']['passport']['endDate']:'-------'}}
						</p>
					</div>
				</div>
				@endif
