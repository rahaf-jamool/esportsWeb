<div class="container pt-3 pb-5 w-100">
    ...
    <div class="modal-body pt-3">
        <form id="edit_team_info_form" method="POST" enctype="multipart/form-data">
            ...
            @if (session('loggedUser')['client']['type'] == 'Academy')
                <input type="hidden" name="academyId" value="{{$teamDetails['academyId']}}" />
            @else
                <input type="hidden" name="clubId" value="{{$teamDetails['clubId']}}" />
            @endif
