...
@section('content')
	<div class="information" style="margin-top: 50px">
		<div class="container" style="padding-top: 100px;">
			<h1 class="text-center my-4">{{ trans('site.add-coach') }}</h1>
            ...
            <form class="form-horizontal" role="form" method="POST" action="{{ url(App::getLocale() . '/register/managment') }}" enctype="multipart/form-data">
                ...
                <div class="form-group {{ $errors->has('socialStatus') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-12 col-lg-9 radio-btn">
                        <label class="radio-inline">
                            <input type="radio" name="socialStatus" value="Married" checked="checked" style="">{{trans('individually.married')}}
                        </label>
                        <label class="radio-inline">
                ...
                <span class="asterisks">*</span><label for="nationality" class="col-11 control-label pb-2 pt-2">{{trans('individually.nationality')}}</label>
                    <div class="col-sm-12">
                        <select name="NationalityId" id="input-zone" class="form-control jcf-reset-appearance input-player" required>
                            <option value="" checked="checked"> --- {{trans('individually.please-choose')}} ---</option>
