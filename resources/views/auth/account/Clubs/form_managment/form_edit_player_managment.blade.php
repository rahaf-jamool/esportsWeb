                ...
                <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                    ...
                    <div class="col-12">
                        <input id="name" type="text" class="form-control {{$errors->first('name') ? "is-invalid" : "" }} "
                            value="{{ is_null($response['name']) ? '' : $response['name'] }}" name="name"
                             required autofocus>
                ...
                <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                    ...
                    <div class="col-12">
                        <input id="email" type="email" class="form-control {{$errors->first('email') ? "is-invalid" : "" }} "
                            value="{{ is_null($response['personInfo']['email']) ? '' : $response['personInfo']['email'] }}" name="email" required>
                        @if ($errors->has('email'))
                            <span class="help-block">
                ...
                <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                    ...
                    <div class="col-12">
                        <input id="phone" type="text" class="form-control {{$errors->first('phone') ? "is-invalid" : "" }} "
                            value="{{ is_null($response['personInfo']['phone']) ? '' : $response['personInfo']['phone'] }}" name="phone" required>
                    ...
                    <select name="educationLevelId" id="input-education-degree"
                        ...
                        @if (!empty($educationLevel))
                            @foreach($educationLevel as $level)
                                ...
                                <option {{ $level['id'] == $response['personInfo']['educationLevelId'] ? 'selected' : '' }} value="{{$level['id']}}">{{ getTranslate($level, 'name') }}</option>
                            @endforeach
                        @endif
                    </select>
                    ...
                    <div class="col-sm-12">
                        <div class="input-group date">
                            <input type="date" name="BirthDate" data-date-format="YYYY-MM-DD"
                                   ...
                                   value="{{ is_null(Carbon\Carbon::parse($response['personInfo']['birthDate'])->format('Y-m-d')) ? '' : Carbon\Carbon::parse($response['personInfo']['birthDate'])->format('Y-m-d') }}" required>
                            ...
                            <div class="form-group required  {{ $errors->has('twitter') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" name="twitter" id="twitter" class="form-control input-player {{$errors->first('twitter') ? "is-invalid" : "" }} "
                                        value="{{ is_null($response['personInfo']['twitter']) ? '' : $response['personInfo']['twitter'] }}">
                            ...
                            <div class="form-group required {{ $errors->has('instagram') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" name="instagram" id="instagram" class="form-control input-player {{$errors->first('instagram') ? "is-invalid" : "" }} "
                                        value="{{ is_null($response['personInfo']['instagram']) ? '' : $response['personInfo']['instagram'] }}">
                                </div>
                            ...
                            <div class="form-group required {{ $errors->has('facebook') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" name="facebook" id="facebook" class="form-control input-player {{$errors->first('facebook') ? "is-invalid" : "" }} "
                                        value="{{ is_null($response['personInfo']['facebook']) ? '' : $response['personInfo']['facebook'] }}">
                                </div>
                            ...
                            <div class="form-group required {{ $errors->has('youtube') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" name="youtube" id="youtube" class="form-control input-player {{$errors->first('youTube') ? "is-invalid" : "" }} "
                                        value="{{ is_null($response['personInfo']['youTube']) ? '' : $response['personInfo']['youTube'] }}">
                            ...
                            <div class="form-group required {{ $errors->has('discord') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" name="discord" id="discord" class="form-control input-player {{$errors->first('discord') ? "is-invalid" : "" }} "
                                        value="{{ is_null($response['personInfo']['discord']) ? '' : $response['personInfo']['discord'] }}">
                                </div>
                            ...
                            <div class="form-group required {{ $errors->has('tikTok') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" name="tikTok" id="tikTok" class="form-control input-player {{$errors->first('tikTok') ? "is-invalid" : "" }} "
                                        value="{{ is_null($response['personInfo']['tikTok']) ? '' : $response['personInfo']['tikTok'] }}">
                                </div>
                            ...
                            <div class="form-group required {{ $errors->has('twitch') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" name="twitch" id="twitch" class="form-control input-player {{$errors->first('twitch') ? "is-invalid" : "" }} "
                                        value=" {{ is_null($response['personInfo']['twitch']) ? '' : $response['personInfo']['twitch'] }}">
                                </div>
                            ...
                            @foreach($platforms as $platform)
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" class="custom-control-input" id="playerPlatforms_{{$platform['id']}}"
                                           ...
                                           @foreach ( $response['playerPlatforms'] as  $val)

                                                @if ($val['platformId'] == $platform['id'])
                                                        checked
                                                @endif
                                           @endforeach >
                            ...
                            @foreach($games as $game)
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" class="custom-control-input" id="playerGames_{{$game['id']}}"
                                           ...
                                           @foreach ( $response['playerGames'] as  $val)
