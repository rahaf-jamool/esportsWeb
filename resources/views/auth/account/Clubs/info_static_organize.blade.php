			...
			<h4 class="p-4">{!! trans('auth.personal-information') !!}</h4>
                ...
                @if (!empty($user['clubTypeName']))
                    <div class="col-12 col-lg-6 m-2 border-bottom mx-auto p-2 d-flex justify-content-between">
                        ...
                        <div class="col-6">
                            <p>
                                {{ !is_null($user['clubTypeName'])?$user['clubTypeName']:''}}
                            </p>
                        </div>
                    </div>
                @endif
				...
				<div class="col-12  mb-2 border-bottom mx-auto pb-2 d-flex justify-content-around">
                        @if(!empty($response['playerPlatforms']))
				...
				<h4 class="p-4">{!! trans('site.licenceinfo') !!}</h4>
                    @if (!empty($user['orgnizationInfo']['licenceNumber']))
                        <div class="col-12 col-lg-6 m-2 border-bottom mx-auto p-2 d-flex justify-content-between">
                            <div class="col-6 text-center">
                                <strong class="product-quantity">
                                {{ trans('site.licenceNumber') }} :
                                </strong>
                            </div>
                            <div class="col-6">
                                <p>
                                {{ !is_null($user['orgnizationInfo']['licenceNumber'])?$user['orgnizationInfo']['licenceNumber']:''}}
                                </p>
                            </div>
                        </div>
                    @endif

                    @if (!empty($user['orgnizationInfo']['licenceIssuar']))
                        <div class="col-12 col-lg-6 m-2 border-bottom mx-auto p-2 d-flex justify-content-between">
                            <div class="col-6 text-center">
                                <strong class="product-quantity">
                                {{ trans('site.licenceIssuar') }} :
                                </strong>
                            </div>
                            <div class="col-6">
                                <p>
                                {{ !is_null($user['orgnizationInfo']['licenceIssuar'])?$user['orgnizationInfo']['licenceIssuar']:''}}
                                </p>
                            </div>
                        </div>
                    @endif
