		...
		{{-- <div class="container p-0" id="account-content"> --}}
			<div class="tab-content">
				{{-- <div id="statistics" class="tab-pane active">
					@include('auth.account.Clubs.statistics', compact('user'))
				</div> --}}
				<div id="info" class="tab-pane active">
					@include('auth.account.Clubs.info_static_organize', compact('user'))
				</div>
				<div id="playersManagement" class="tab-pane">
					@include('auth.account.Clubs.playersManagement', compact('user'))
				</div>
				<div id="CoachadminisManage" class="tab-pane">
					@include('auth.account.Clubs.CoachadminisManage', compact('user'))
				</div>
				<div id="teamManagement" class="tab-pane">
					@include('auth.account.Clubs.teamManagement', compact('user'))
				</div>
				...
				<div id="membershipCard" class="tab-pane">
                    @include('auth.account.Clubs.membership-card', compact('user'))
				</div>
			</div>
		{{-- </div> --}}
	</div>
