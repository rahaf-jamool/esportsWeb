		...
		{{-- <div class="container p-0" id="account-content"> --}}
			<div class="tab-content">
				<div id="statistics" class="tab-pane active">
					@include('auth.account.player.statistics', compact('user'))
				</div>
				<div id="info" class="tab-pane">
					@include('auth.account.player.info_static', compact('user'))
				</div>
				<div id="teamManagement" class="tab-pane">
					@include('auth.account.player.teamManagement', compact('user'))
				</div>
				<div id="electronicservices" class="tab-pane">
				@include('auth.account.online-services-forms.electronicservices-certification', compact('user'))
				</div>
				...
				<div id="membershipCard" class="tab-pane">
                    @include('auth.account.player.membership-card', compact('user'))
				</div>
			</div>
		{{-- </div> --}}
	</div>
