...
<table style="" dir="{{ trans('all.dir') }}" border="0" align="right" cellpadding="1" cellspacing="1">
    ...
    <tr>
        <td>
            {{ trans('all.notify-user-event-register-success' , ['name' =>($symbol=='ar')?$user->Member->Title:$user->Member->TitleE  , 'title'=> $item->{$symbol.'_name'} , 'price'=>  ($item->offer->isNotEmpty())? $item->offer[0]->NewPrice:  (float) $item->sellprice]) }}
        </td>
    </tr>
    <tr>
        <td>
