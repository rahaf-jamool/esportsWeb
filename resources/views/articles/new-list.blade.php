...
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-xs-12">
                    <div class="alert alert-warning">
                        تنويه : كون المقالات في هذا القسم تعود لصحفيين جدد فهناك احتمال أن تحتوي على بعض الخلل من ناحيتي الصياغة اللغوية والمحتوى.. يرجى أخذ هذا بعين الإعتبار
                    </div>
                    <br>
                    <br>
                </div>
    ...
    <script type="text/javascript">
        var _config = {
            getGetArticlesUrl: '{{ url($symbol.'/articles/new/get_all_ajax_articles/')}}',
