...
.clubRegistration legend{
    ...
    <div class="container clubRegistration">
        <div class="row pb-5">
                <h1> {!! trans('individually.register-content-writer-account') !!}</h1>
                ...
                <form class="form-horizontal" role="form" method="POST"
                    ...
                    {{ csrf_field() }}
                    <input type="hidden" name="account-type" value="Content-Creator">

                    <h4>{!! trans('individually.content-writer-data') !!}</h4>
                    <hr>
                                                                    ...
                                                                    <div class="cart-content-info">
                                                                        <ul class="list-unstyled">
                                                                            ...
                                                                            <li>{{trans('auth.account-type')}} : <span
                                                                                    id="card_account-type"></span>{{trans('auth.Content-Creator')}} </li>
