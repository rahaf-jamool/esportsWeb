                    ...
                    <div class="tabs" id="tabbedForm">
                        ...
                        <div class="tab" data-name="{{trans('individually.General')}}">
                            <div class="d-flex flex-wrap">
                                <div class="form-group {{ $errors->has('account-type') ? ' has-error' : '' }} col-12 ">
                                ...
                                <fieldset id="payment-container games" class="games1 col-12 col-lg-6">
                        ...
                        <div class="tab" data-name="{{trans('individually.Person-Info')}}">
                            <div class="d-flex flex-wrap">
                                ...
                                <div class="form-group residence-only {{ $errors->has('princedomId') ? ' has-error' : '' }} col-12 col-md-6" id="princedom">
                                    ...
                                    <div class="col-12">
                                        <select name="princedomId" class="form-control jcf-reset-appearance input-player">
                                ...
                                <div class="form-group residence-only {{ $errors->has('passportNumber') ? ' has-error' : '' }} col-12 col-md-6">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" name="passportNumber" value="" id="passportNumber"
    ...
    <script>
        $(document).ready(function () {
            ...
            $('input[name="uaeResidency"]').change(function () {
             ...
             $('#card_account-type').text('{{trans("auth.Coach")}}');
            $('input[name="account-type"]').change(function (e) {

                if($('input[name="account-type"]:checked').val() == 'Manager'){
                    $('#card_account-type').text('{{trans("auth.Manager")}}' );
                } else {
                    $('#card_account-type').text('{{trans("auth.Coach")}}' );
                }

               /*  $('#card_account-type').text($('input[name="account-type"]:checked').val());  */
            });
