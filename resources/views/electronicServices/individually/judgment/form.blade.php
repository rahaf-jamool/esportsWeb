        ...
        <div class="col-12 col-lg-9">
            @include('layouts.message')
                    <form class="form-horizontal" role="form" method="POST" action="{{ url(App::getLocale() . '/register') }}">
                        ...
                        {{--  --}}
                        <div class="form-group required {{ $errors->has('experience-details') ? ' has-error' : '' }}">
                            <span>* </span><label for="experience-details" class="col-md-4 control-label pb-2 pt-2">{{trans('individually.experience-details')}}</label>
                            <div class="col-sm-12">
                                <textarea id="input-ex" name="experience-details" rows="4" cols="50" maxlength="200" class="form-control input-player"></textarea>
                            </div>
                            @if ($errors->has('experience-details'))
                                <span class="help-block">
                                    <strong>{{ $errors->first('experience-details') }}</strong>
                                </span>
                            @endif
                        </div>
                        <div class="form-group required {{ $errors->has('certificates') ? ' has-error' : '' }}">
                            <span>* </span><label for="certificates" class="col-md-4 control-label pb-2 pt-2">{{trans('individually.certificates')}}</label>

                            <div class="col-sm-12">
                                <textarea id="input-ch" name="certificates" rows="4" cols="50" maxlength="200"  class="form-control input-player"></textarea>
                            </div>
                        ...
                        <div class="form-group required {{ $errors->has('the-reviewer') ? ' has-error' : '' }}">
                            <span>* </span><label for="the-reviewerr" class="col-md-4 control-label pb-2 pt-2">{{trans('individually.the-reviewer')}}</label>
                            <div class="col-sm-12">
                                <span class="file-input btn btn-primary btn-file">
                                    {{trans('individually.upload-file')}}<input type="file">
                            </div>
                            @if ($errors->has('the-reviewer'))
                                <span class="help-block">
                                    <strong>{{ $errors->first('the-reviewer') }}</strong>
                                </span>
                            @endif
                        </div>
                        ...
                        <div class="form-group required {{ $errors->has('cv') ? ' has-error' : '' }}">
                            <span>* </span><label for="cv" class="col-md-4 control-label pb-2 pt-2">{{trans('individually.cv')}}</label>
                            <div class="col-sm-12">
                                <span class="file-input btn btn-primary btn-file">
                                    {{trans('individually.upload-file')}} <input type="file">
                            </div>
                        ...
                        <div class="form-group required {{ $errors->has('passport-photo') ? ' has-error' : '' }}">
                            <span>* </span><label for="emirates-passport-number" class="col-md-4 control-label pb-2 pt-2">{{trans('individually.passport-photo')}}</label>
                            <div class="col-sm-12">
                                <span class="file-input btn btn-primary btn-file">
                                    {{trans('individually.upload-file')}}  <input type="file">
                            </div>
                        ...
                        <div class="form-group required {{ $errors->has('residence') ? ' has-error' : '' }}">
                            <span>* </span><label for="residence" class="col-md-4 control-label pb-2 pt-2">{{trans('individually.residence')}}</label>
                            <div class="col-sm-12">
                                <span class="file-input btn btn-primary btn-file">
                                    {{trans('individually.upload-file')}}  <input type="file">
                            </div>
