...
<div class="container clubRegistration">
    <div class="row pt-5">
        <h1>{{trans('site.organizationrequest')}}</h1>
        {{-- <p>{!! trans('institutions.Ifyouhaveaccount') !!}<a href="">{!! trans('institutions.loginpage') !!}</a>.</p> --}}

        <div class="dropsown-two">
            <div class="order-dropdown">
                <div class="button">
                    <p>{{trans('site.organizationrequest')}}</p>
            ...
            <div class="order-dropdown">
                <div class="button2">
                    <p>{{trans('institutions.conspiracy')}}</p>
                    <img src="https://svgshare.com/i/8u6.svg" alt="" class="arrow">
                </div>
                <div class="dropdown2">
                    <a href="#">التصنيف محلي
    ...
    <script>
        $(document).ready(function(){
            ...
            $(".button2").click(function() {
                $(".dropdown2 a").removeClass("clicked");
                $(".dropdown2 a").children("span").removeClass("clicked");
                $(".arrow").toggleClass("open");
