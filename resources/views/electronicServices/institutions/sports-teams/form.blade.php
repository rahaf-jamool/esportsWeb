<div class="container clubRegistration">
    <div class="row pt-5">
        <h1> {!! trans('institutions.sportsteamsRegistration') !!}</h1>
        ...
        <div class="col-12 col-lg-9">
            @include('layouts.message')
                    <form class="form-horizontal" role="form" method="POST" action="{{ url(App::getLocale() . '/register') }}">
                        {{ csrf_field() }}
                        <h4>{!! trans('institutions.sportsteamsDetails') !!}</h4>
                        <hr>
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            <span>* </span><label for="name" class="col-md-4 control-label  pb-2 pt-2">{{trans('institutions.sportsteamsName')}}</label>
                        ...
                        <h4 class="pt-4">{!! trans('institutions.games') !!}</h4>
                        <hr>
                        <div class="form-group{{ $errors->has('game') ? ' has-error' : '' }}">
                            <span>* </span><label for="game" class="col-md-4 control-label pb-2 pt-2">{{trans('institutions.game')}}</label>
                            <div class="col-md-12 col-lg-9">
                            <select id="multiple" class="js-states form-control multiple" multiple>
                                <option>game1</option>
                                <option>game2</option>
                                <option>game3</option>
                                <option>game4</option>
                        ...
                        <div class="form-group{{ $errors->has('otherGame') ? ' has-error' : '' }}">
                            <span>  </span><label for="otherGame" class="col-md-4 control-label pb-2 pt-2">{{trans('institutions.otherGame')}}</label>
                            <div class="col-md-12 col-lg-9">
                                <input id="otherGame" type="text" class="form-control" name="otherGame">
                                @if ($errors->has('otherGame'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('otherGame') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
                        <h4 class="pt-4">{!! trans('institutions.players') !!}</h4>
                        <hr>
                        <div class="form-group{{ $errors->has('player') ? ' has-error' : '' }}">
                            <span>* </span><label for="player" class="col-md-4 control-label pb-2 pt-2">{{trans('institutions.player')}}</label>
                            <div class="col-md-12 col-lg-9">
                            <select id="multiple1" class="js-states form-control multiple" multiple>
                        ...
                        <div class="form-group{{ $errors->has('otherplayer') ? ' has-error' : '' }}">
                            <span>  </span><label for="otherplayer" class="col-md-4 control-label pb-2 pt-2">{{trans('institutions.otherplayer')}}</label>
                            <div class="col-md-12 col-lg-9">
                                <input id="otherplayer" type="text" class="form-control" name="otherplayer">
                                @if ($errors->has('otherplayer'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('otherplayer') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="form-group{{ $errors->has('coupon') ? ' has-error' : '' }}">
                            ...
                            <div class="d-flex col-md-12 col-lg-9">
                                ...
                                <div class="col-4 btn btn-primary " style="font-size: 15px;">
